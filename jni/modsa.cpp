...
void CModSAWindow::SetCoordFlyDistance(float distance)
{
    fDist = distance;
}

float CModSAWindow::GetCoordFlyDistance()
{
    return (float)fDist;
}

void CModSAWindow::ShowCoordFly(bool bShow)
{
    if(!bShow)return;

    ImGui::Text("Distance / Speed (default: 2.5)");

    if(ImGui::Button("Add", ImVec2(90, 50)))
    {
        SetCoordFlyDistance((GetCoordFlyDistance() + 0.5));
        ////pChatWindow->AddInfoMessage("{F6D200}[{F60000}INFO{F6D200}] {FFFFFF}Set distance to %f", GetCoordFlyDistance());
        char str[4096];
        sprintf(str, "~n~~n~~n~~n~~n~~n~Distance: %f", GetCoordFlyDistance());
        pGame->DisplayGameText(str, 5000, 3);
    }

    ImGui::SameLine(0, pGUI->GetFontSize());

    if(ImGui::Button("Del", ImVec2(90, 50)))
    {
        SetCoordFlyDistance((GetCoordFlyDistance() - 0.5));
        ////pChatWindow->AddInfoMessage("{F6D200}[{F60000}INFO{F6D200}] {FFFFFF}Set distance to %f", GetCoordFlyDistance());
        char str[4096];
    ...
    VECTOR vecMoveSpeed;
    pGame->FindPlayerPed()->ApplyAnimation("FALL_SKYDIVE", "PED", 4.1, 1, 0, 0, 1, 1);

    if(ImGui::Button("FRONT", ImVec2(150, 50)))
    {
        pGame->FindPlayerPed()->ForceTargetRotation(352.46);
        if(!pGame->FindPlayerPed()->IsInVehicle()){
            vecMoveSpeed.X = 0.0f;
            vecMoveSpeed.Y = GetCoordFlyDistance();
            vecMoveSpeed.Z = 0.0f;
            ...
            ScriptCommand(&set_car_coordinates, pGame->FindPlayerPed()->GetCurrentVehicleID(), mat.pos.X, mat.pos.Y + GetCoordFlyDistance(), mat.pos.Z);
        }
    ...
    if(ImGui::Button("UP", ImVec2(150, 50)))
    {
        if(!pGame->FindPlayerPed()->IsInVehicle()){
            pGame->FindPlayerPed()->TeleportTo(mat.pos.X, mat.pos.Y, mat.pos.Z + GetCoordFlyDistance() * 2.0);
        }else{
            ScriptCommand(&set_car_coordinates, pGame->FindPlayerPed()->GetCurrentVehicleID(), mat.pos.X, mat.pos.Y, mat.pos.Z + GetCoordFlyDistance());
        }
        pGame->GetCamera()->SetBehindPlayer();  
    }
    ...
    if(ImGui::Button("DOWN", ImVec2(150, 50)))
    {
        if(!pGame->FindPlayerPed()->IsInVehicle()){
            pGame->FindPlayerPed()->TeleportTo(mat.pos.X, mat.pos.Y, mat.pos.Z - GetCoordFlyDistance() * 2.0);
        }else{
    ...
    if(ImGui::Button("LEFT", ImVec2(150, 50)))
    {
        ...
        if(!pGame->FindPlayerPed()->IsInVehicle()){
            vecMoveSpeed.X -= GetCoordFlyDistance();
            vecMoveSpeed.Y = 0.0f;
            vecMoveSpeed.Z = 0.0f;
            pGame->FindPlayerPed()->SetMoveSpeedVector(vecMoveSpeed);
        }else{
            ScriptCommand(&set_car_z_angle, pGame->FindPlayerPed()->GetCurrentVehicleID(), 85.51);
            ScriptCommand(&set_car_coordinates, pGame->FindPlayerPed()->GetCurrentVehicleID(), mat.pos.X - GetCoordFlyDistance(), mat.pos.Y, mat.pos.Z);
        }
        pGame->GetCamera()->SetBehindPlayer();  
    }
    ...
    if(ImGui::Button("LEFT-BACK", ImVec2(150, 50)))
    {
        ...
        if(!pGame->FindPlayerPed()->IsInVehicle()){
            ...
            ScriptCommand(&set_car_coordinates, pGame->FindPlayerPed()->GetCurrentVehicleID(), mat.pos.X - GetCoordFlyDistance(), mat.pos.Y - GetCoordFlyDistance(), mat.pos.Z);
        }
        pGame->GetCamera()->SetBehindPlayer();  
    }
    ...
    if(ImGui::Button("RIGHT-FRONT", ImVec2(150, 50)))
    {
    ...
    if(ImGui::Button("RIGHT-BACK", ImVec2(150, 50)))
    {
    ...
    if(ImGui::Button("LEFT-FRONT", ImVec2(150, 50)))
    {
        ...
        if(!pGame->FindPlayerPed()->IsInVehicle()){
            ...
            ScriptCommand(&set_car_coordinates, pGame->FindPlayerPed()->GetCurrentVehicleID(), mat.pos.X - GetCoordFlyDistance(), mat.pos.Y, mat.pos.Z + GetCoordFlyDistance());
        }
        pGame->GetCamera()->SetBehindPlayer();  
    }
    ...
    if(ImGui::Button("Lock", ImVec2(350, 50)))
    {
        ScriptCommand(&lock_actor, pGame->FindPlayerPed()->m_dwGTAId, 1);
    }

    if(ImGui::Button("Unlock", ImVec2(350, 50)))
    {
...
void CModSAWindow::Render()
{
    ...
    switch(m_bMenuStep){
        case 2:
        if(m_bWallHack == 1){
            if(ImGui::Button("(O) Wall Hack", ImVec2(350, 50)))
            {
                ToggleCheat(2);
                Show(false);
            }
        }else{
            if(ImGui::Button("Wall Hack", ImVec2(350, 50)))
            {
                ToggleCheat(2);
                Show(false);
            }
        ...
        if(m_bNF == 1){
            if(ImGui::Button("(O) No Fall", ImVec2(350, 50)))
            {
                ToggleCheat(5);
                Show(false);
            }
        }else{
            if(ImGui::Button("No Fall", ImVec2(350, 50)))
            {
                ToggleCheat(5);
                Show(false);
            }
        ...
        if(m_bGodMode == 1){
            if(ImGui::Button("(O) God Mode", ImVec2(350, 50)))
            {
                ToggleCheat(1);
                Show(false);
            }
        }else{
            if(ImGui::Button("God Mode", ImVec2(350, 50)))
            {
                ToggleCheat(1);
                Show(false);
            }
        ...
        // TODO : if(ImGui::Button("Air Break", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }

        if(m_bCols == 1){
            if(ImGui::Button("(O) Freeze", ImVec2(350, 50)))
            {
                ToggleCheat(3);
                Show(false);
            }
        }else{
            if(ImGui::Button("Freeze", ImVec2(350, 50)))
            {
                ToggleCheat(3);
                Show(false);
            }
        ...
        if(ImGui::Button("Fly Hack", ImVec2(350, 50)))
        {
            m_bMenuStep = 11;
        }

        if(m_bKrutilka == 1){
            if(ImGui::Button("(O) Behind", ImVec2(350, 50)))
            {
                ToggleCheat(4);
                Show(false);
            }
        }else{
            if(ImGui::Button("Behind", ImVec2(350, 50)))
            {
                ToggleCheat(4);
                Show(false);
            }
        ...
        if(ImGui::Button("Gravity", ImVec2(350, 50)))
        {
            m_bMenuStep = 4;
        }
        ...
        break;
        case 1:
        if(ImGui::Button("Cheats", ImVec2(350, 50)))
        {
            m_bMenuStep = 2;
        }

        // TODO : if(ImGui::Button("Danger Cheats", ImVec2(350, 50)))
        // TODO : {
        // TODO :     m_bMenuStep = 6;
        // TODO : }

        if(ImGui::Button("Weapons", ImVec2(350, 50)))
        {
            m_bMenuStep = 5;
        }

        // TODO : if(ImGui::Button("Vehicles", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }

        if(ImGui::Button("Teleports", ImVec2(350, 50)))
        {
            m_bMenuStep = 7;
        }

        if(ImGui::Button("Settings", ImVec2(350, 50)))
        {
            m_bMenuStep = 3;
        }

        // TODO : if(ImGui::Button("GTA Patches", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }

        if(ImGui::Button("SA-MP Patches", ImVec2(350, 50)))
        {
            m_bMenuStep = 8;
        }
        ...
        break;
        case 3:
        if(ImGui::Button("Clear chat", ImVec2(350, 50)))
        {
            for(int i = 0; i <= 50; i++)//pChatWindow->AddInfoMessage(" ");
            Show(false);
        }

        // TODO : if(ImGui::Button("Disable nicknames", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }

        if(lockinp == 1){
            if(ImGui::Button("(O) Lock chat input", ImVec2(350, 50)))
            {
                if(lockinp == 0){
                    lockinp = 1;
            ...
            if(ImGui::Button("Lock chat input", ImVec2(350, 50)))
            {
                if(lockinp == 0){
                    lockinp = 1;
                    //pChatWindow->AddInfoMessage("{F6D200}[{F60000}INFO{F6D200}] {FFFFFF}Chat input lock is enabled!");
        ...
        if(ImGui::Button("Restore Gravity", ImVec2(350, 50)))
        {
            pGame->SetGravity(0.008);
            //pChatWindow->AddInfoMessage("{F6D200}[{F60000}INFO{F6D200}] {FFFFFF}Set gravity to %f", pGame->GetGravity());
            char str[4096];
        ...
        case 5:
        if(ImGui::Button("Brass Knuckles", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Golf Club", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Baton", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Knife", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Baseball Bat", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Shovel", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Pool Cue", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Katana", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Chainsaw", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Purple Dildo", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Dildo", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Vibrator", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Silver Vibrator", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Flowers", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Cane", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Grenade", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Tear Gas", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Molotov Cocktail", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("9mm", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Silenced 9mm", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Desert Eagle", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Shotgun", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Sawnoff Shotgun", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Combat Shotgun", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("UZI", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("MP5", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("AK-47", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("M4", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("TEC-9", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Country Rifle", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Sniper Rifle", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("RPG", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("HS Rocket", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Flamethrower", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Minigun", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("C-4", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Detonator", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Spraycan", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Fire Extinguisher", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Camera", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Night Vis Goggles", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Thermal Goggles", ImVec2(350, 50)))
        {
        ...
        if(ImGui::Button("Parachute", ImVec2(350, 50)))
        {
        ...
        case 6:
        // TODO : if(ImGui::Button("Damager", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Crasher", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Rvanka (onfoot)", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Rvanka (onvehicle)", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Car Shot", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Car Anarchy", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Car Fault", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
// TODO : 
        // TODO : if(ImGui::Button("Underground Explosion", ImVec2(350, 50)))
        // TODO : {
        // TODO :     Show(false);
        // TODO : }
        ...
        break;
        case 7:
        if(ImGui::Button("Маркер", ImVec2(350, 50)))
        {
            ToggleTeleport(69);
            Show(false);
        }

        if(ImGui::Button("Мэрия ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(0);
            Show(false);
        }
        
        if(ImGui::Button("Завод", ImVec2(350, 50)))
        {
            ToggleTeleport(1);
            Show(false);
        }

        if(ImGui::Button("Ферма", ImVec2(350, 50)))
        {
            ToggleTeleport(2);
            Show(false);
        }

        if(ImGui::Button("Гора Vinewood", ImVec2(350, 50)))
        {
            ToggleTeleport(3);
            Show(false);
        }

        if(ImGui::Button("Небоскрёб", ImVec2(350, 50)))
        {
            ToggleTeleport(4);
            Show(false);
        }

        if(ImGui::Button("ЖД ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(5);
            Show(false);
        }

        if(ImGui::Button("ЖД ЛВ", ImVec2(350, 50)))
        {
            ToggleTeleport(6);
            Show(false);
        }

        if(ImGui::Button("ЖД СФ", ImVec2(350, 50)))
        {
            ToggleTeleport(7);
            Show(false);
        }

        if(ImGui::Button("Автобусная стоянка", ImVec2(350, 50)))
        {
            ToggleTeleport(8);
            Show(false);
        }

        if(ImGui::Button("Таксопарк", ImVec2(350, 50)))
        {
            ToggleTeleport(9);
            Show(false);
        }

        if(ImGui::Button("Улица Грув", ImVec2(350, 50)))
        {
            ToggleTeleport(10);
            Show(false);
        }

        if(ImGui::Button("Переулок Эммета", ImVec2(350, 50)))
        {
            ToggleTeleport(11);
            Show(false);
        }

        if(ImGui::Button("Willowfield", ImVec2(350, 50)))
        {
            ToggleTeleport(12);
            Show(false);
        }

        if(ImGui::Button("Глен Парк", ImVec2(350, 50)))
        {
            ToggleTeleport(13);
            Show(false);
        }

        if(ImGui::Button("LSPD", ImVec2(350, 50)))
        {
            ToggleTeleport(14);
            Show(false);
        }

        if(ImGui::Button("LVPD", ImVec2(350, 50)))
        {
            ToggleTeleport(15);
            Show(false);
        }

        if(ImGui::Button("SFPD", ImVec2(350, 50)))
        {
            ToggleTeleport(16);
            Show(false);
        }

        if(ImGui::Button("Автошкола", ImVec2(350, 50)))
        {
            ToggleTeleport(17);
            Show(false);
        }

        if(ImGui::Button("Автосалон ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(18);
            Show(false);
        }

        if(ImGui::Button("Автосалон ЛВ", ImVec2(350, 50)))
        {
            ToggleTeleport(19);
            Show(false);
        }

        if(ImGui::Button("Автосалон СФ", ImVec2(350, 50)))
        {
            ToggleTeleport(20);
            Show(false);
        }

        if(ImGui::Button("Мотосалон ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(21);
            Show(false);
        }

        if(ImGui::Button("Vagos #1", ImVec2(350, 50)))
        {
            ToggleTeleport(22);
            Show(false);
        }

        if(ImGui::Button("Vagos #2", ImVec2(350, 50)))
        {
            ToggleTeleport(23);
            Show(false);
        }

        if(ImGui::Button("Rifa", ImVec2(350, 50)))
        {
            ToggleTeleport(24);
            Show(false);
        }

        if(ImGui::Button("Aztecas", ImVec2(350, 50)))
        {
            ToggleTeleport(25);
            Show(false);
        }

        if(ImGui::Button("Больница ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(26);
            Show(false);
        }

        if(ImGui::Button("Больница ЛВ", ImVec2(350, 50)))
        {
            ToggleTeleport(27);
            Show(false);
        }

        if(ImGui::Button("Больница СФ", ImVec2(350, 50)))
        {
            ToggleTeleport(28);
            Show(false);
        }

        if(ImGui::Button("База ФБР", ImVec2(350, 50)))
        {
            ToggleTeleport(29);
            Show(false);
        }

        if(ImGui::Button("Шахта", ImVec2(350, 50)))
        {
            ToggleTeleport(30);
            Show(false);
        }

        if(ImGui::Button("Гора Чилиад", ImVec2(350, 50)))
        {
            ToggleTeleport(31);
            Show(false);
        }

        if(ImGui::Button("Аэропорт", ImVec2(350, 50)))
        {
            ToggleTeleport(32);
            Show(false);
        }

        if(ImGui::Button("Склад", ImVec2(350, 50)))
        {
            ToggleTeleport(33);
            Show(false);
        }

        if(ImGui::Button("ЖД ЛС #2", ImVec2(350, 50)))
        {
            ToggleTeleport(34);
            Show(false);
        }

        if(ImGui::Button("24/7 Магазин", ImVec2(350, 50)))
        {
            ToggleTeleport(35);
            Show(false);
        }

        if(ImGui::Button("Маяк", ImVec2(350, 50)))
        {
            ToggleTeleport(36);
            Show(false);
        }

        if(ImGui::Button("Чёртово колесо", ImVec2(350, 50)))
        {
            ToggleTeleport(37);
            Show(false);
        }

        if(ImGui::Button("АЗС", ImVec2(350, 50)))
        {
            ToggleTeleport(38);
            Show(false);
        }

        if(ImGui::Button("Пиццерия", ImVec2(350, 50)))
        {
            ToggleTeleport(39);
            Show(false);
        }

        if(ImGui::Button("Перекрасочная", ImVec2(350, 50)))
        {
            ToggleTeleport(40);
            Show(false);
        }

        if(ImGui::Button("Банк ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(41);
            Show(false);
        }

        if(ImGui::Button("Аммунация ЛС", ImVec2(350, 50)))
        {
            ToggleTeleport(42);
            Show(false);
        }

        if(ImGui::Button("Скейт Парк", ImVec2(350, 50)))
        {
            ToggleTeleport(43);
            Show(false);
        }

        if(ImGui::Button("Отель #1", ImVec2(350, 50)))
        {
            ToggleTeleport(44);
            Show(false);
        }

        if(ImGui::Button("Отель #2", ImVec2(350, 50)))
        {
            ToggleTeleport(45);
            Show(false);
        }

        if(ImGui::Button("Доки", ImVec2(350, 50)))
        {
            ToggleTeleport(46);
            Show(false);
        }

        if(ImGui::Button("Свалка", ImVec2(350, 50)))
        {
            ToggleTeleport(47);
            Show(false);
        }

        if(ImGui::Button("Зона 51 (В)", ImVec2(350, 50)))
        {
            ToggleTeleport(48);
            Show(false);
        }

        if(ImGui::Button("Зона 51 (А)", ImVec2(350, 50)))
        {
            ToggleTeleport(49);
            Show(false);
        }

        if(ImGui::Button("ECDD", ImVec2(350, 50)))
        {
            ToggleTeleport(50);
            Show(false);
        }

        if(ImGui::Button("Мафия ЛВ #1", ImVec2(350, 50)))
        {
            ToggleTeleport(51);
            Show(false);
        }

        if(ImGui::Button("Мафия ЛВ #2", ImVec2(350, 50)))
        {
            ToggleTeleport(52);
            Show(false);
        }

        if(ImGui::Button("Русская Мафия", ImVec2(350, 50)))
        {
            ToggleTeleport(53);
            Show(false);
        }

        if(ImGui::Button("Мафия СФ", ImVec2(350, 50)))
        {
            ToggleTeleport(54);
            Show(false);
        }

        if(ImGui::Button("Алхамбра", ImVec2(350, 50)))
        {
            ToggleTeleport(55);
            Show(false);
        }
        ...
        case 8:
        if(ImGui::Button("Ignor Incoming RPC", ImVec2(350, 50)))
        {
            m_bMenuStep = 9;
        }

        if(ImGui::Button("Ignor Outcoming RPC", ImVec2(350, 50)))
        {
            m_bMenuStep = 10;
        }

        if(ImGui::Button("Ignor Incoming Packet", ImVec2(350, 50)))
        {
            Show(false);
        }

        if(ImGui::Button("Ignor Outcoming Packet", ImVec2(350, 50)))
        {
            Show(false);
        }
        ...
        case 9:
        //if(ImGui::Button("SetPlayerName", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerPos", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerPosFindZ", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bPH == 1){
            if(ImGui::Button("(O) SetPlayerHealth", ImVec2(350, 50)))
            {
                ToggleRPC(4);
                Show(false);
            }
        }else{
            if(ImGui::Button("SetPlayerHealth", ImVec2(350, 50)))
            {
                ToggleRPC(4);
                Show(false);
            }
        ...
        //if(ImGui::Button("TogglePlayerControllable", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PlaySound", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerWorldBounds", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GivePlayerMoney", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerFacingAngle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ResetPlayerMoney", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bRPW == 1){
            if(ImGui::Button("(O) ResetPlayerWeapons", ImVec2(350, 50)))
            {
                ToggleRPC(8);
                Show(false);
            }
        }else{
            if(ImGui::Button("ResetPlayerWeapons", ImVec2(350, 50)))
            {
                ToggleRPC(8);
                Show(false);
            }
        ...
        //if(ImGui::Button("GivePlayerWeapon", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bVP2 == 1){
            if(ImGui::Button("(O) SetVehicleParamsEx", ImVec2(350, 50)))
            {
                ToggleRPC(1);
                Show(false);
            }
        }else{
            if(ImGui::Button("SetVehicleParamsEx", ImVec2(350, 50)))
            {
                ToggleRPC(1);
                Show(false);
            }
        ...
        //if(ImGui::Button("CancelEdit", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerTime", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ToggleClock", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("WorldPlayerAdd", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerShopName", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerSkillLevel", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerDrunkLevel", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("Create3DTextLabel", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DisableCheckpoint", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetRaceCheckpoint", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DisableRaceCheckpoint", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GameModeRestart", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PlayAudioStream", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("StopAudioStream", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("RemoveBuildingForPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bCO == 1){
            if(ImGui::Button("(O) CreateObject", ImVec2(350, 50)))
            {
                ToggleRPC(3);
                Show(false);
            }
        }else{
            if(ImGui::Button("CreateObject", ImVec2(350, 50)))
            {
                ToggleRPC(3);
                Show(false);
            }
        ...
        //if(ImGui::Button("SetObjectPos", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetObjectRot", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DestroyObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DeathMessage", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerMapIcon", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("RemoveVehicleComponent", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("Update3DTextLabel", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ChatBubble", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("UpdateSystemTime", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
        ...
        if(m_bSD == 1){
            if(ImGui::Button("(O) ShowDialog", ImVec2(350, 50)))
            {
                ToggleRPC(6);
                Show(false);
            }
        }else{
            if(ImGui::Button("ShowDialog", ImVec2(350, 50)))
            {
                ToggleRPC(6);
                Show(false);
            }
        ...
        //if(ImGui::Button("DestroyPickup", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("WeaponPickupDestroy", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("LinkVehicleToInterior", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerArmor", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerArmedWeapon", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetSpawnInfo", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerTeam", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PutPlayerInVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bRPFV == 1){
            if(ImGui::Button("(O) RemovePlayerFromVehicle", ImVec2(350, 50)))
            {
                ToggleRPC(5);
                Show(false);
            }
        }else{
            if(ImGui::Button("RemovePlayerFromVehicle", ImVec2(350, 50)))
            {
                ToggleRPC(5);
                Show(false);
            }
        ...
        //if(ImGui::Button("SetPlayerColor", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DisplayGameText", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ForceClassSelection", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("AttachObjectToPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("InitMenu", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ShowMenu", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("HideMenu", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("CreateExplosion", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ShowPlayerNameTagForPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("AttachCameraToObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("InterpolateCamera", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetObjectMaterial", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GangZoneStopFlash", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
        ...
        if(m_bAPA == 1){
           if(ImGui::Button("(O) ApplyAnimations", ImVec2(350, 50)))
            {
                ToggleRPC(7);
                Show(false);
            }
        }else{
            if(ImGui::Button("ApplyAnimations", ImVec2(350, 50)))
            {
                ToggleRPC(7);
                Show(false);
            }
        ...
        //if(ImGui::Button("ClearAnimations", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerSpecialAction", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerFightingStyle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerVelocity", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bVV == 1){
            if(ImGui::Button("(O) SetVehicleVelocity", ImVec2(350, 50)))
            {
                ToggleRPC(2);
                Show(false);
            }
        }else{
            if(ImGui::Button("SetVehicleVelocity", ImVec2(350, 50)))
            {
                ToggleRPC(2);
                Show(false);
            }
        ...
        //if(ImGui::Button("SetPlayerDrunkVisuals", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ClientMessage", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetWorldTime", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("CreatePickup", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetVehicleTireStatus", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("MoveObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("EnableStuntBonusForPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("TextDrawSetString", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetCheckpoint", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GangZoneCreate", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PlayCrimeReport", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerAttachedObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GangZoneDestroy", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GangZoneFlash", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("StopObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetNumberPlate", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("TogglePlayerSpectating", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PlayerSpectatePlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PlayerSpectateVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerWantedLevel", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ShowTextDraw", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("TextDrawHideForPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ServerJoin", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ServerQuit", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("InitGame", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
        //
        //if(ImGui::Button("RemovePlayerMapIcon", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerAmmo", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerGravity", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetVehicleHealth", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("AttachTrailerToVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DetachTrailerFromVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerDrunkHandling", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DestroyPickups", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetWeather", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerSkin", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerInterior", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerCameraPos", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetPlayerCameraLookAt", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetVehiclePos", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetVehicleZAngle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}

        if(m_bVP == 1){
            if(ImGui::Button("(O) SetVehicleParams", ImVec2(350, 50)))
            {
                ToggleRPC(0);
                Show(false);
            }
        }else{
            if(ImGui::Button("SetVehicleParams", ImVec2(350, 50)))
            {
                ToggleRPC(0);
                Show(false);
            }
        ...
        //if(ImGui::Button("SetCameraBehindPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("WorldPlayerRemove", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("WorldVehicleAdd", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("WorldVehicleRemove", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("WorldPlayerDeath", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("EnterVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("EnterEditObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SCMEvent", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("Chat", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SrvNetStats", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ClientCheck", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DamageVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("EditAttachedObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("EditObject", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("RequestClass", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("RequestSpawn", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ExitVehicle", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("UpdateScoresPingsIPs", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
...
//
        ...
        //}
//
        //if(ImGui::Button("ClickPlayer", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ClientJoin", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ScriptCash", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ServerCommand", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("Spawn", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("Death", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("NPCJoin", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("DialogResponse", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("ClickTextDraw", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("GiveTakeDamage", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("SetInteriorId", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("MapMarker", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("PickedUpPickup", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("MenuSelect", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("VehicleDestroyed", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
        //if(ImGui::Button("MenuQuit", ImVec2(350, 50)))
        //{
        //    Show(false);
        //}
//
